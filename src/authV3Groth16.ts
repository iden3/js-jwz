...
import { AuthV3Circuit, AuthV3_8_32_Circuit, Groth16, prove, verify } from './common';
...
export const provingMethodGroth16AuthV3_8_32_Instance: ProvingMethod =
  new ProvingMethodGroth16AuthV3(new ProvingMethodAlg(Groth16, AuthV3_8_32_Circuit));
