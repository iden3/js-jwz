...
// Increase timeout for proof generation tests (ZK proofs take time)
const PROOF_TIMEOUT = 120000;
...
describe('dynamicProve and dynamicVerify', () => {
  ...
  describe('dynamicProve with DynamicProofInputsPreparerHandlerFunc', () => {
    it(
      'should prove and verify with authV3 and authV3-8-32 circuits using dynamic inputs preparer',
      async () => {
